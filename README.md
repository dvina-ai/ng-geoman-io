...
_IMPORTANT NOTE: We have renamed this package from `@asymmetrik/angular2-leaflet-draw` to `@dvina/ngx-leaflet-geoman`_
...
import { LeafletDrawModule } from '@dvina/ngx-leaflet-geoman';
...
Both of these changes are new in `@dvina/ngx-leaflet-geoman@6`, and were made to match default Leaflet Draw behavior.
